...
public class History extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //取得歷史紀錄
        new GetHistory().execute(getUser());
    ...
    private class GetHistory extends AsyncTask<String,String,String> {
        ...
        protected void onPreExecute(){
            pd = ProgressDialog.show(context(History.this),"","載入中...",true);
        }

        @Override
        protected String doInBackground(String... params) {
            Connection connect = new Connection(1101,SH,params[0]);//紀錄
    ...
    void setBook(String data){
        ...
        try {
            ...
            if(ja.toString().equals("[]")){//無借書紀錄，顯示訊息
                ...
                //為ListView添加容器
                sa = new SimpleAdapter(History.this, list,R.layout.history_item,
    ...
    private void NextPage(Class link){
        b.putInt("fromHistory",fromHistory);
